...
if (validar($_REQUEST))
{
	...
	$fechafalta = $_REQUEST['fechafalta'];
	
	// Me creo un gestor de asistencias
	$gestor = new GestorAsistencias();
	// Saco por pantalla en formato JSON el resultado
	$vista->imprimir($gestor->justificarAsistencia($idalumno, $idasignatura, $fechafalta));
}
else
{
